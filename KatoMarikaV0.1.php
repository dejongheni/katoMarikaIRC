...
while (is_resource($socket)){
  ...
  if ($d[3]==':'.$prefixe.'help'){
    ...
    if ($d[3]==':'.$prefixe.'test'){
      ...
      //.autokick : active/désactive l'autokick
      if ($d[3]==':'.$prefixe.'autokick'){
    	  $demandeur=substr($d[0], 1);
        $tab=explode("!",$demandeur);
        $demandeur=$tab[0];
        ...
        //.op : affiche les users op aux yeux du bot
        if ($d[3]==':'.$prefixe.'op'){
          $demandeur=substr($d[0], 1);
          $tab=explode("!",$demandeur);
          $demandeur=$tab[0];
          ...
          if ($d[3]==':'.$prefixe.'deop'){
            ...
            //prefixe : set le prefixe des commandes
              if ($d[3]==':'.$prefixe.'prefixe'){
                $demandeur=substr($d[0], 1);
                $tab=explode("!",$demandeur);
                $demandeur=$tab[0];
                if(in_array($demandeur, $opList)){
                ...
                //&voice : active le droit de parler d'un user
                if ($d[3]==':'.$prefixe.'voice'){
                  $demandeur=substr($d[0], 1);
                  $tab=explode("!",$demandeur);
                  $demandeur=$tab[0];
                  if(in_array($demandeur, $opList)){
                  ...
                  //&unvoice : enlève le droit de parler d'un user
                  if ($d[3]==':'.$prefixe.'unvoice'){
                    $demandeur=substr($d[0], 1);
                    $tab=explode("!",$demandeur);
                    $demandeur=$tab[0];
                    if(in_array($demandeur, $opList)){
